...
import { getStatusBadge, getDateTitle } from '@/lib/daily-budget-utils';
...
/**
 * Component for the daily budget header with navigation and date picker
 */
            ...
            <div className="flex flex-col items-center gap-1 flex-1">
              ...
              <div className="mt-2">
                <DatePicker
                  ...
                  onChange={(date) => onDateSelect(date.toISOString().split('T')[0])}
